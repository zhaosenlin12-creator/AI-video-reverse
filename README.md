...
基于 AI四小只 账号真实抓取数据（2026-08-23 MediaCrawler 抓取），
互动分最高的视频是：

> **刚接触 AI？一定要先搭个人知识库！**（互动分 14143，账号历史第一）

### 5 段结构（25-30s）

```
【0-3s 钩子】标题 = 受众 + 一定要 + 具体动作
【3-12s 主体1】咱普通人 + 价值点 + 屏幕证据
【12-20s 主体2】白衬衫少年 + 数字步骤 (2/3 步)
【20-26s 收尾】双重价值 + 评论互动
【26-30s 黑场】"是这样吗" 弹幕
```
...
**实测发现**（2026-08-23 W35 视频减少推荐 50%+）：

### 红线

1. **避免点名第三方 AI 工具**（非字节系）：
   - ❌ WorkBuddy / Cursor / Claude / Trae / DeepSeek 等
   - ✅ 通用描述："AI 工具"、"代码助手"、"桌面 Agent"
   - ✅ 举例用字节自家：豆包 / 即梦 / 剪映 / 飞书

2. **避免"装 / 下载 / 注册 / 购买"动词** + 第三方品牌名
   - ❌ "装 WorkBuddy"、"下 Trae"
   - ✅ "搭知识库"、"学 AI"、"做笔记"
...
| 安全 ✅ | 违规 ❌ |
|---|---|
| 豆包 / 即梦 / 剪映 / 飞书 / Codex | WorkBuddy / Cursor / Claude / Trae / DeepSeek |
